...
Цей додаток додає нові функції до програм і забезпечує глобальну підтримку.
...
* NVDA+Shift+v, показує назву програми, 32/64 біт, використання ЦП, версію, назву продукту.
